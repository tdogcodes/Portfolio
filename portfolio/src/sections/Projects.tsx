...
const portfolioProjects = [
  ...
  },
  {
    ...
    results: [
      { title: "Built a Next.js landing page with TypeScript for Layers, a design platform to share work and mock-ups" },
      { title: "User interactivity and web accessibility features, styled with Tailwind, CVA, & Framer Motion for animations" },
    ],
