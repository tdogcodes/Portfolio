  ...
  const workExperience = [
    {
      ...
      results: [
        {
          title:
            "Developed a new company website using React, TypeScript, CSS, and Firebase. created a custom CMS to streamline article creation and management.",
        },
        {
          title:
            "Collaborated in an Agile environment with product managers and designers to plan, design, and deliver user-focused features with rapid iteration and feedback.",
        },
        {
            title:
                "Implemented responsive design and optimized performance across devices, improving page load speed and mobile usability.",
        },
      ],
    },
  ];
